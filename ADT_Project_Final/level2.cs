...
namespace ADT_Project_Final
{
    public partial class level2 : Form
    {
        ...
        void update_currentuser_Database()
        {
            ...
            string currentuser_query = "update currentuser set level=2, seconds=@sec";
        ...
        void update_highscore_Database()
        {
            ...
            if (highscoreCount == 5)
            {
                string search_highscore_desc = "select * from dbo.highscore order by level desc";
                ...
                string search_highscore_asc = "select * from dbo.highscore order by level";
